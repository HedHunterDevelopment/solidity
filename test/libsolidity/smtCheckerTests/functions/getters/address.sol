...
// Info 1180: Contract invariant(s) for :C:\n(true || true || true)\nReentrancy property(ies) for :C:\n(true || true || ((<errorCode> = 0) && ((:var 2) = (:var 5)) && (x' = x) && (y' = y)) || true || true || true)\n(true || true || true || true || ((<errorCode> = 0) && ((:var 2) = (:var 5)) && (x' = x) && (y' = y)) || true)\n<errorCode> = 0 -> no errors\n<errorCode> = 1 -> Assertion failed at assert(a == x)\n<errorCode> = 2 -> Assertion failed at assert(a == address(this))\n<errorCode> = 3 -> Assertion failed at assert(b == y)\n<errorCode> = 4 -> Assertion failed at assert(y == address(this))\n
