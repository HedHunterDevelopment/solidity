...
// Info 1180: Contract invariant(s) for :C:\n(true || true)\nReentrancy property(ies) for :C:\n((<errorCode> = 0) && ((:var 0) = (:var 1)))\n<errorCode> = 0 -> no errors\n<errorCode> = 1 -> Assertion failed at assert(f(C.T.wrap(0x42)) == 0x42)\n<errorCode> = 2 -> Assertion failed at assert(f(C.T.wrap(0x42)) == 0x43)\n<errorCode> = 3 -> Assertion failed at assert(C.T.unwrap(g(0x42)) == 0x42)\n<errorCode> = 4 -> Assertion failed at assert(C.T.unwrap(g(0x42)) == 0x43)\n<errorCode> = 5 -> Assertion failed at assert(h(0x42) == 0x42)\n<errorCode> = 6 -> Assertion failed at assert(h(0x42) == 0x43)\n<errorCode> = 7 -> Assertion failed at assert(C.T.unwrap(i(C.T.wrap(0x42))) == 0x42)\n<errorCode> = 8 -> Assertion failed at assert(C.T.unwrap(i(C.T.wrap(0x42))) == 0x43)\n
